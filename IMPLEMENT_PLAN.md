...
| L-4 | Unresolved E0; consumed B8.5R5 remains no-retry; checkpoint `2509213`/B8.6R10 v12 is incomplete immutable history; B8.6R11/v13 is a synthetic closed-world remediation pending Inspector review; `edge_claim none` | Inspector review, then a separately approved v13 activation checkpoint before one bounded provisioning attempt; validation remains sealed |
