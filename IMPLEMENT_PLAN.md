...
| L-4 | Unresolved E0; B8.7 funds the four planning tests, B8.8R5/v6 machinery was activated, and B8.8R5AR-X records that the legacy runtime tracker accidentally consumed the v6 one-shot without producing a scientific report; `edge_claim none` | Inspector closure review and user integration decision for B8.8R5AR-X; no retry is allowed, and any future execution requires a new owner-approved gate/namespace with validation sealed |
