...
| L-4 | Unresolved E0; consumed B8.5R5 remains no-retry; checkpoint `2509213`/B8.6R10 v12 is incomplete immutable history; B8.6R11A activation checkpoint is ready but not provisioning; `edge_claim none` | Inspector review and Exact-SHA CI of this checkpoint, then a separately approved one bounded v13 provisioning attempt; validation remains sealed |
