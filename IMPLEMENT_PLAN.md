...
| L-4 | Unresolved E0; consumed B8.5R5 remains no-retry; checkpoint `2509213`/B8.6R10 v12 is incomplete immutable history; B8.6R11B one-shot v13 command is consumed and `blocked_before_runtime_schema_contract_mismatch_no_retry`; `edge_claim none` | Inspector/owner review; no retry, backtest, or L-4 scientific run without a new order; validation remains sealed |
