...
| L-4 | Active planning E0; B8.3 and B8.4R2/v3 accepted; B8.5/v1, B8.5R/v2, B8.5R2/v3, and B8.5R3/v4 rejected immutable history, B8.5R4/v5 hash-binds lifecycle-corrected structural machinery; `edge_claim none` | Phase B and activation are not executed; wait for Inspector acceptance plus later activation checkpoint, then at most one structural U8 preflight only |
