...
| L-4 | Unresolved E0; consumed B8.5R5 remains no-retry, B8.6R6/v8 is rejected history, and B8.6R7/v9 is a synthetic closed-world remediation pending Inspector review; `edge_claim none` | Inspector review, then a separately approved v9 activation checkpoint before one bounded provisioning attempt; validation remains sealed |
