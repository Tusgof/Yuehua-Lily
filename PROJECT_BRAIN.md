...
- **L-3 B7.14R5/v7 checkpoint**: v7 is an in-progress E0-only cross-platform remediation. It preserves v5/v6, binds their committed LF blobs and the rejected authored-Windows hash encoding through an exact addendum, and binds only synthetic scanner/report fixtures. All fourteen authorizations remain false; validation is sealed, edge_claim is none, and L-3 remains E1 scope_restricted.
