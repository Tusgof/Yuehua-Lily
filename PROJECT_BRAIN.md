...
Keep validation returns sealed and do not rerun B4.11, B4.12, or B7.3. L-3 is E1 scope_restricted because its sole run was invalidated after exceeding the 465 observation ceiling; any future L-3 work needs a new owner-authorized preregistration and one-run order. No UAT work is planned: a hostname reference is not a public UAT entitlement. Any future broker probe requires genuinely new official evidence or a dedicated owner-controlled test account, explicit owner approval, and a new locked gate.
