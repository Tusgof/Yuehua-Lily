...
The current safe action is CP-A Inspector review of the owner-authorized B8.8R5/v6 superseding remediation. B8.8R4/v5 is rejected history and must not be used for execution. Review does not authorize activation or real-return access; a separate canonical activation order remains required. No UAT work is planned: a hostname reference is not a public UAT entitlement.
