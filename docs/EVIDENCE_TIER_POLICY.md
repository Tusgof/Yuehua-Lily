...
- Lily `docs/DECISION_RECORD_001_PROJECT_REFOUNDING.md` and `experiments/hypothesis_registry.json`: promoted sources for the economic mechanism, hypotheses L-0 through L-4, whipsaw kill zone, breadth precondition, and Lily-specific evidence scope.
