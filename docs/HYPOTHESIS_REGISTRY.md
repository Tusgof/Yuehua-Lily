...
B8.4R2: L-4 remains edge_claim none; v3 synthetic E0 preflight active, validation sealed. B8.5/v1 is immutable rejected history; B8.5R/v2 is the runnable structural E0 contract. Phase B is not executed and awaits Inspector acceptance.
