...
- **B7.14 v3 rejected / B7.14R v4**: v3 hard-stopped at `unknown_structural_key` before session-date or return decoding, but one skipped timestamp lexeme was UTF-8 decoded; Inspector rejects its scope representation. v4 is E0 synthetic-only remediation with no further container access.
