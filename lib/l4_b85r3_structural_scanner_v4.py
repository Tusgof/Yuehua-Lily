"""Capacity-aware, byte-only scanner for the future B8.5R3 one-shot preflight."""
...
MANIFEST_SCHEMA = "lily_l4_b85r3_structural_manifest_v4"
PAYLOAD_SCHEMA = "lily_l4_b85r3_u8_symbol_session_dates_v4"


def canonical_payload_capacity_bytes() -> int:
    """Largest compact payload with eight 4,096-date arrays of YYYY-MM-DD strings."""
