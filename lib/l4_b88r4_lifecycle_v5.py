"""Gate-owned v5 activation and immutable provenance helpers; no data I/O."""
...
def activation_ok(root: Path, commit: str) -> dict[str, Any] | None:
    ...
    # Preflight enforces a clean checkout before the marker is claimed.  The
    # report validator runs after that claim and therefore must not reject its
    # own marker/report/ledger outputs as a dirty dependency.
