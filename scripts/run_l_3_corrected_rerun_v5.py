"""B7.9 fixture-only scanner; it has no real-container interface."""
...
FIXTURE_ROOT = ROOT / "tests/fixtures/l3_corrected_rerun_v5"
if str(ROOT) not in sys.path:
    sys.path.insert(0, str(ROOT))
from lib.l3_corrected_rerun_v5 import build_canonical_schedule, scan_synthetic_envelope


def main() -> int:
    parser = argparse.ArgumentParser(description="Run only a committed B7.9 synthetic fixture.")
