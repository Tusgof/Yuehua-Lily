"""B8.6R12/v14 runtime; callable only through the committed bootstrap."""
...
def run_one_shot(*, root: Path, commit: str, dependency_identities: dict, activation: dict) -> dict:
    ...
    from lib.l4_b86r12_contract_v14 import DATASET, EXPECTED_DATASET_SHA256, MANIFEST, MARKER, MAX_BYTES, PAYLOAD, REPORT, REPORT_SCHEMA, SEAL, U8, artifact, atomic_write_all, canonical, claim_once, sha256
    ...
    if blocker:
        ...
        try:
            ...
            manifest = {"schema_version": "lily_l4_b86r12_falsification_manifest_v14", "dataset_reference": DATASET, "dataset_sha256": scanned["dataset_sha256"], "dataset_byte_count": scanned["dataset_byte_count"], "u8_members_in_order": list(U8), "coverage_by_symbol": scanned["coverage_by_symbol"], "session_count": scanned["session_count"], "max_session_date": scanned["max_session_date"], "validation_seal": SEAL}
            payload = {"schema_version": "lily_l4_b86r12_u8_session_dates_v14", "dataset_sha256": scanned["dataset_sha256"], "u8_members_in_order": list(U8), "session_dates_by_symbol": scanned["session_dates_by_symbol"]}
