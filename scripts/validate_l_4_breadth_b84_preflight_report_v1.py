...
B84_GATE = "experiments/l_4_breadth_b84_activation_contract_v1.json"
B84_VALIDATOR = "scripts/validate_l_4_breadth_b84_activation_contract_v1.py"
FIXTURE = "tests/fixtures/l4_b84/synthetic_preflight_report.json"
...
def validate(payload: Any, *, committed_fixture: bool = False) -> dict[str, Any]:
    ...
    blockers: list[str] = []
    try:
        schema = json.loads((ROOT / "schemas/l_4_breadth_b84_preflight_report_v1.schema.json").read_text(encoding="utf-8"))
