...
from lib.l3_b714_date_only_scanner_v7 import ScanError, enforce_weekly_pair_ceiling, scan_synthetic_date_only
from scripts.run_l_3_b714_date_only_preflight_v7 import guard_workspace_clean, run_synthetic
from scripts.validate_l_3_b714_date_only_preflight_remediation_v7 import validate as validate_gate
from scripts.validate_l_3_b714_date_only_preflight_report_v7 import ATTESTATION, REPORT, validate


class B714V5Tests(unittest.TestCase):
    def test_gate_and_golden_pair_pass(self) -> None:
        blob = subprocess.run(["git", "show", "f458c32249e398428c421477f373f96840f92a1f:experiments/l_3_b714_date_only_preflight_remediation_v7.json"], capture_output=True, check=True).stdout
        self.assertEqual("576b4ddd85cce521a1eb56a2633374ec4254434f925d77992cd662fb4a29553e", hashlib.sha256(blob).hexdigest())
