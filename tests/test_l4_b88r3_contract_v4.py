...
from lib.l4_b88r3_scientific_engine_v4 import CURRENT_EXPENSE_RATIOS, U4, U8, _costs, derive, l1_ewma_cross_check, psd_clip, threshold_changes
...
class B88R3V4(unittest.TestCase):
    ...
    def test_forged_future_report_is_blocked_before_any_claim(self):
        spec=importlib.util.spec_from_file_location("report_validator",ROOT/"scripts/validate_l_4_breadth_b88r3_scientific_report_v4.py")
        module=importlib.util.module_from_spec(spec); spec.loader.exec_module(module)
        value=container(); report={"schema_version":"lily_l4_b88r3_scientific_report_v4","order_id":"B8.8R3","hypothesis_id":"L-4","mode":"future_falsification_only","evidence_tier":"E1","edge_claim":"none","provenance":{},"validation_seal":{"status":"sealed_not_accessed","accessed":False},"access_counts":{},"container_sha256":"0"*64,"derived":{},"outcome":"falsified_E1_only"}
    ...
    def test_direct_runtime_refuses_without_preflight_or_marker(self):
        spec=importlib.util.spec_from_file_location("runtime",ROOT/"scripts/run_l_4_breadth_b88r3_scientific_execution_v4.py")
        module=importlib.util.module_from_spec(spec); spec.loader.exec_module(module)
    ...
    def test_phase_a_bootstrap_refuses_without_activation(self):
        spec=importlib.util.spec_from_file_location("bootstrap",ROOT/"scripts/run_l_4_breadth_b88r3_committed_bootstrap_v4.py")
        module=importlib.util.module_from_spec(spec); spec.loader.exec_module(module)
        checked=module.preflight(ROOT, __import__("subprocess").check_output(["git","rev-parse","HEAD"],cwd=ROOT,text=True).strip())
        self.assertIn(checked["outcome"], {"canonical_activation_absent", "dirty_checkout"})
        self.assertFalse((ROOT/"reports/experiments/l_4_breadth_b88r3_one_shot_marker_v4.json").exists())
